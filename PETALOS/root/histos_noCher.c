void histos_noCher(){
    ...
    TFile *fIn1 = new TFile("/home/jmbenlloch/next/petalo/work/histo/lXe_refl97_VUV3mm_xy2.4cm_z5cm_noCher_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
    TFile *fIn2 = new TFile("/home/jmbenlloch/next/petalo/work/histo/lyso_refl97_VUV3mm_xy2.4cm_z5cm_noCher_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
	...
	h2->Fit("gauF2","","e",-15,15);

	h2->SetTitle("DTOF (Scint)");
	...
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/crt_noCher.pdf");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/crt_noCher.png");
}
