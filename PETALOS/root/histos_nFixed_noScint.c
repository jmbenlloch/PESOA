void histos_nFixed_noScint(){

	gStyle->SetOptFit(0);
	gStyle->SetOptStat(0);

    TFile *fIn1 = new TFile("/home/jmbenlloch/next/petalo/work/histo/lXe_refl97_VUV3mm_xy2.4cm_z5cm_n1.7_noScint_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
    TFile *fIn2 = new TFile("/home/jmbenlloch/next/petalo/work/histo/lyso_refl97_VUV3mm_xy2.4cm_z5cm_n1.8_noScint_QE_1_SPTR_0_ASIC_0_DT300_histos.root", "read");
	...
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_noScint.pdf");
	c1->Print("/home/jmbenlloch/next/petalo/work/histo/crt_nFixed_noScint.png");
}
