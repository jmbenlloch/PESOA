...
############################################################
	def ComputeTimeMap(self,event):
		...
		for hit in sensorhits:
			...
			Ah = hit.GetAmplitude()
			self.m.log(5, " ++++++hit, ID+++++++ = ", hid)
			self.m.log(5, ' xh =%7.2f, yh =%7.2f, zh =%7.2f, A =%d ng =%7.2f '%(
			xh/mm,yh/mm,zh/mm,Ah,ng1))
		...
		self.m.log(4, ' ng1 =%7.2f, ng2 =%7.2f '%(ng1,ng2))
